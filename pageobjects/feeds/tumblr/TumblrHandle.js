...
import {TUMBLR} from '../../utils/constant.js';
...
class TumblrHandle {
  ...
  async tumblrHandle() {
    ...
    await test.step('Step 2: Fill handle input with "hisbodycorpse"', async () => {
      await this.enterHandle.fill(TUMBLR.TUMBLRHANDLE);
    });
