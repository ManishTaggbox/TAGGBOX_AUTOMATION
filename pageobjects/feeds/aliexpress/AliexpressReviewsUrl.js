...
import {AliExpress} from '../../utils/constant.js';

class AliexpressReviewsUrl {
  constructor(page) {
    this.page = page;
    this.enterReviewsUrl = page.locator("input[id='Aliexpress-Reviews Url-text']");
    this.createFeedBtn = page.locator('#create_feed');
  }

  async aliexpressReviewsUrl() {
    await test.step('Step 1: Fill Aliexpress Reviews URL', async () => {
...
module.exports = AliexpressReviewsUrl;
