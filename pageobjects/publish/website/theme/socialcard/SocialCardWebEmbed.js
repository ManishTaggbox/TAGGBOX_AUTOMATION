...
class SocialCardWebEmbed {
  ...
  // Core locators
  get firstCard() { return this.page.locator("//div[@class='tb_nc_post_wrap_in']").first(); }
  get instagramIcon() { return this.firstCard.locator("//div[@class='tb-instagram-default tb__icon tb_ico_default']"); }
  get authorName() { return this.firstCard.locator(".tb_nc_authorname"); }
  get authorHandle() { return this.firstCard.locator(".tb_nc_username"); }
