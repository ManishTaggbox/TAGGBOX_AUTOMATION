...
class EditPostTags 
{
    ...
    async editPostTags() 
    {
        ...
        await test.step("Step 3: Enter new tag and select from dropdown", async () => 
        {
        ...
        await test.step("Step 7: Assert added post tags in details tab", async () => 
        {
        ...
        await test.step("Step 9: Assert added post tags", async () => 
        {
