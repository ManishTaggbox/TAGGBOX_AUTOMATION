...
class DashboardPageLinks
{
    ...
    async dashboardPageLinks() 
    {
        await test.step("Step 1: Count the total number of links present on the dashboard page", async () => 
        {
            const count = await this.links.count();
            console.log(`🔍 Found ${count} links on Dashboard page`);
        });
...
export default DashboardPageLinks;
